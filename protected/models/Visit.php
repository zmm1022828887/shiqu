...
class Visit extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('from_user, to_user, create_time', 'required'),
			array('from_user, to_user, create_time,is_visit', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, from_user, to_user, create_time,is_visit', 'safe', 'on'=>'search'),
		);
	}
