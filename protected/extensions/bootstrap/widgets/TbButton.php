...
class TbButton extends CWidget
{
	...
	*/
	...
	public function init()
	{
        ...
        if (isset($this->click)) {
            $this->click = CJavaScript::encode($this->click);
        }
    }
	...
	public function run()
	{
        ...
        if($this->buttonType == self::BUTTON_LINK && isset($this->click)) {
            $js = "\n$(document).on('click','#{$this->getId()}', function(){\n
                var fn = {$this->click}; if($.isFunction(fn)){fn();}});\n";
