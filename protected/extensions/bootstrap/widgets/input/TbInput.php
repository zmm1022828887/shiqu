...
abstract class TbInput extends CInputWidget {
    ...
    const TYPE_DROPDOWN_TREE = 'dropdowntree';
    const TYPE_FILE = 'filefield';
    const TYPE_FILE_EXT = 'filefieldext';
    ...
    public function run() {
        switch ($this->type) {
            ...
            case self::TYPE_COLORSELECTOR:
                $this->colorselectorField();
                break;
            ...
            // Adding timepicker_ext (fl)
            case self::TYPE_TIMEPICKER_EXT:
                $this->timepickerExtField();
                break;
            ...
            case self::TYPE_TAGSELECTOR:
                $this->tagselectorField();
                break;
            ...
            case self::TYPE_NUMBER:
                $this->numberField();
            case self::TYPE_SELECTOR:
                $this->selector();
                break;
            case self::TYPE_FILE_EXT:
                $this->fileFieldExt();
                break;
            case self::TYPE_REMIND:
                $this->remind();
                break;
            case self::TYPE_ICONSELECTOR:
                $this->iconselectorField();
                break;
            default:
    ...
    protected function getPrepend() {
        if ($this->hasAddOn()) {
            ...
            if (isset($htmlOptions['class']))
                $htmlOptions['class'] = 'add-on ' . $htmlOptions['class'];
            else
     ...
     * ### .dropDownTree()
     *
     * Renders a drop down tree (select tree).
     *
     * @return string the rendered content
     * @abstract
     */
    abstract protected function dropDownTree();
    ...
    /**
     * Renders a extended file field.
     * @return string the rendered content
     * @abstract
     */
    abstract protected function fileFieldExt();
     ...
     * @abstract
     */
    abstract protected function colorselectorField();
    ...
    /**
     * Renders a timepicker extense field.
     * @return string the rendered content
     * @abstract
     */
    abstract protected function timepickerExtField();
     ...
     * @return mixed
     */
    abstract protected function tagselectorField();
     ...
     * ### .selector()
     *
     * Renders a selector (textarea).
     *
     * @return string the rendered content
     * @abstract
     */
    abstract protected function selector();
    
    /**
     * ### .remind()
     *
     * Renders remind list (checkbox).
     *
     * @return string the rendered content
     * @abstract
     */
    abstract protected function remind();
     ...
     * @abstract
     */
    abstract protected function iconSelectorField();
