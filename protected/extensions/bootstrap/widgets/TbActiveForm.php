...
class TbActiveForm extends CActiveForm
{
	 ...
	 *### dropDownTreeRow()
	 *
	 * Renders a drop-down tree input row.
	 *
	 * @param CModel $model the data model
	 * @param string $attribute the attribute
	 * @param array $data the list data
	 ...
	 * @return string the generated row
	 */
	public function dropDownTreeRow($model, $attribute, $data=array(), $htmlOptions = array())
	{
		return $this->inputRow(TbInput::TYPE_DROPDOWN_TREE, $model, $attribute, $data, $htmlOptions);
	}
	 ...
	 * @return string the generated row
	 */
	public function fileFieldExtRow($model, $attribute, $htmlOptions = array())
	{
		return $this->inputRow(TbInput::TYPE_FILE_EXT, $model, $attribute, null, $htmlOptions);
	}
	 ...
	 * @return string the generated row
	 */
	public function selectorRow($model, $attribute, $htmlOptions = array())
	{
		return $this->inputRow(TbInput::TYPE_SELECTOR, $model, $attribute, null, $htmlOptions);
	}
	 ...
	 *### .remindRow()
	 *
	 * Renders a TRemind checkbox list
	 *
	 * @param string $attribute
	 * @param array $htmlOptions
	 * @return string
	 */
    public function remindRow($model, $htmlOptions = array()) {
        return $this->inputRow(TbInput::TYPE_REMIND, $model, null, null, $htmlOptions);
    }
	 ...
	 * @param CModel $model the data model
	 * @param string $attribute the attribute
	 * @param array $htmlOptions additional HTML attributes. 'options' key specify 
         *  configuration options of datepicker respectively.
	 * @return string the generated row
	 * @since zq
	 */
	 ...
	 *### .colorselectorRow()
	 *
	 * Renders a colorselector field row.
	 *
	 * @param CModel $model the data model
	 * @param string $attribute the attribute
	 * @param array $htmlOptions additional HTML attributes. 'events' and 'options' key specify the events
	 ...
	 * @since 1.0.0 
	 */
	public function colorselectorRow($model, $attribute, $htmlOptions = array())
	{
		return $this->inputRow(TbInput::TYPE_COLORSELECTOR, $model, $attribute, null, $htmlOptions);
	}
	...
	/**
	 * Renders a timepicker extense field row.
	 * @param CModel $model the data model
	 * @param string $attribute the attribute
	 * @param array $htmlOptions additional HTML attributes
	 * @return string the generated row
	 * @since 0.10.0
	 */
	public function timepickerExtRow($model, $attribute, $htmlOptions = array())
	{
		return $this->inputRow(TbInput::TYPE_TIMEPICKER_EXT, $model, $attribute, null, $htmlOptions);
	}
	 ...
	 * @return string
	 */
	public function tagSelectorRow($model, $attribute, $htmlOptions = array())
	{
		return $this->inputRow(TbInput::TYPE_TAGSELECTOR, $model, $attribute, null, $htmlOptions);
	}
...
EOD;
	 ...
	 *### .iconSelectorRow()
	 *
	 * Renders a iconselector field row.
     * 
     * @param Cmodel $model
     * @param string $attribute
     * @param array $htmlOptions
     */
    public function iconSelectorRow($model, $attribute, $htmlOptions = array()){
        return $this->inputRow(TbInput::TYPE_ICONSELECTOR, $model, $attribute, null, $htmlOptions);
    }
