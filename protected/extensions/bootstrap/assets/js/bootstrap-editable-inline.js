...
(function ($) {
    ...
    //buttons
    $.fn.editableform.buttons = '<button type="submit" class="btn btn-primary editable-submit"><i class="icon-checkmark"></i></button>'+
                                '<button type="button" class="btn editable-cancel"><i class="icon-cancel"></i></button>';
