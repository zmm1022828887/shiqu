...
(function ($) {
    ...
    //buttons
    $.fn.editableform.buttons = '<button type="submit" class="btn btn-primary editable-submit btn-danger"><i class="icon-checkmark"></i></button>'+
                                '<button type="button" class="btn editable-cancel btn-success"><i class="icon-cancel"></i></button>';
