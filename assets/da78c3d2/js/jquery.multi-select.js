...
!function ($) {
  ...
  * ====================== */
  ...
  var MultiSelect = function (element, options) {
    ...
    this.$spliter = $('<div class="ms-spliter"><i class="icon-transmission-2"></i></div>');
  ...
  MultiSelect.prototype = {
    ...
    init: function(){
      ...
      var ulHeight = ms.height();
      var ulWidth = ms.width();
      that.$selectableUl.css({'height':ulHeight, 'width':ulWidth});
      that.$selectionUl.css({'height':ulHeight, 'width':ulWidth});
      that.$spliter.height(ulHeight);
        ...
        that.$container.append(that.$spliter);
